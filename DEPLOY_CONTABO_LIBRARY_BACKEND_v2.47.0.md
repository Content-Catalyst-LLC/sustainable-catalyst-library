# Deploy Knowledge Library backend v2.47.0

Copy `sustainable-catalyst-library-backend-v2.47.0.zip` and `upgrade_library_backend_v2_47_0_contabo.sh` to `/tmp` on the Contabo host, then run the installer with sudo.

The installer:
1. verifies Python backend 2.47.0, Go runtime 0.1.0 and Rust runtime 0.2.0 source identities;
