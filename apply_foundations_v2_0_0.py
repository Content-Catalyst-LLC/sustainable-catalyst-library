#!/usr/bin/env python3
"""Patch the Sustainable Catalyst Library bootstrap for Foundations v2.0.0."""
...
def main() -> int:
    ...
    print("Bootstrap patched." if changed else "Bootstrap already contains Foundations v2.0.0.")
    return 0
