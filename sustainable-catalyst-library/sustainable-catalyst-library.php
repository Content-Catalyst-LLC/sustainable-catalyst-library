 ...
 * Description: Sustainable Catalyst Library v4.3.12 moves Field Spotlight hero copy and supporting-article selections into a dedicated durable panel-content store, eliminating the partial settings merge path that could discard saved article slots while preserving v4.3.9 presentation behavior.
 * Version: 4.3.12
...
define('SC_LIBRARY_VERSION', '4.3.12');
