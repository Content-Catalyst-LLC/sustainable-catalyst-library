 ...
 * Description: Sustainable Catalyst Library v5.11.0 with Carbon & Nature Intelligence v0.5.0 and Energy Systems Intelligence v0.9.0, adding Energy Decision Intelligence with governed criteria, portable decision packets, neutral comparison matrices, readiness inspection, provenance and uncertainty visibility while preserving Global Energy Intelligence and the full prior Energy Systems stack.
 * Version: 5.11.0
...
define('SC_ENERGY_SYSTEMS_VERSION', '0.9.0');
