 ...
 * Description: Sustainable Catalyst Library v5.11.0 with Carbon & Nature Intelligence v0.5.0 and Energy Systems Intelligence v0.8.0, adding Global Energy Intelligence with live dated country observations, source/freshness governance, country profiles and same-indicator comparisons while preserving bioenergy, scenario economics, energy balances, renewable technologies, sustainability indicators, and the source-bound numeric registry.
 * Version: 5.11.0
...
define('SC_ENERGY_SYSTEMS_VERSION', '0.8.0');
