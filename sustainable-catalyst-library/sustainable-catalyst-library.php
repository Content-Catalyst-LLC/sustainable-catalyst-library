 ...
 * Description: Sustainable Catalyst Library v4.3.11 repairs Field Spotlight admin persistence with an explicit verified save transaction, so hero copy and supporting-article selections persist reliably and invalidate the public Spotlight cache immediately, while preserving the v4.3.10 slot binding repair and v4.3.9 presentation behavior.
 * Version: 4.3.11
...
define('SC_LIBRARY_VERSION', '4.3.11');
