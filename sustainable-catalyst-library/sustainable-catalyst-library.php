 ...
 * Description: A native WordPress knowledge base with a resumable index scanner, structured indexing, relationships, research notebooks, sources, Technical Translation Matrices, Whiteboards, Chalkboards, Annotation Studio handwriting, custom books, a Foundations Documentation Library, content planner, complete public registry, roadmap tracker, PostgreSQL and portable research-data exports, planning analytics, dependency intelligence, release coordination, persistent account workspaces, Render synchronization, server-side book and PDF production, frozen editions, authority and version controls, search, filters, and public REST endpoints.
 * Version: 1.13.2
...
define('SC_LIBRARY_VERSION', '1.13.2');
