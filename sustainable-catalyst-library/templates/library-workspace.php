...
$workspace_intro = $workspace_intro ?? __('Combine publications, notes, and outside sources in a portable research workspace.', 'sustainable-catalyst-library');
$workspace_standalone = $workspace_standalone ?? false;
$workspace_open = $workspace_open ?? false;
?>
<section class="sc-library-workspace-shell<?php echo $workspace_standalone ? ' sc-library-workspace-shell--standalone' : ''; ?>" data-sc-library-workspace-root data-workspace-standalone="<?php echo $workspace_standalone ? '1' : '0'; ?>">
    ...
    <div class="sc-library-workspace" data-library-workspace <?php echo $workspace_open ? '' : 'hidden'; ?>>
        ...
        <aside class="sc-library-workspace__panel" role="dialog" aria-modal="<?php echo $workspace_standalone ? 'false' : 'true'; ?>" aria-labelledby="sc-library-workspace-title">
            ...
            <p class="sc-library-workspace__privacy"><?php esc_html_e('This v1.2 workspace is stored only in this browser unless you export it. It does not change the original publication.', 'sustainable-catalyst-library'); ?></p>
            <nav class="sc-library-workspace__tabs" aria-label="<?php esc_attr_e('Research Notebook sections', 'sustainable-catalyst-library'); ?>">
                <button type="button" data-workspace-tab="overview" class="is-active"><?php esc_html_e('Overview', 'sustainable-catalyst-library'); ?></button>
