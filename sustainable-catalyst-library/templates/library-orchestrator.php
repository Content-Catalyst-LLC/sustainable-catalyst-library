<section class="sc-orchestrator<?php echo $orchestrator_compact ? ' is-compact' : ''; ?><?php echo $orchestrator_front_door ? ' is-front-door' : ''; ?>" data-sc-library-orchestrator data-initial-intent="<?php echo esc_attr($orchestrator_intent); ?>" data-initial-record="<?php echo esc_attr($orchestrator_record); ?>" data-orchestrator-mode="<?php echo esc_attr($orchestrator_mode); ?>" data-full-url="<?php echo esc_attr($orchestrator_full_url); ?>">
    ...
    <form class="sc-orchestrator__form" data-orchestrator-form>
        <label class="sc-orchestrator__question">
            ...
            <textarea name="prompt" rows="<?php echo $orchestrator_front_door ? '3' : '4'; ?>" required maxlength="1200" placeholder="<?php echo esc_attr($orchestrator_placeholder); ?>"></textarea>
        </label>
        <?php if ($orchestrator_front_door) : ?>
            ...
            <div class="sc-orchestrator__front-door-actions">
                <button type="submit" class="is-primary"><?php echo esc_html($orchestrator_button_label ?: __('Ask the Library', 'sustainable-catalyst-library')); ?></button>
    ...
    <div class="sc-orchestrator__output" data-orchestrator-output>
        <div class="sc-orchestrator__empty">
            <strong><?php echo $orchestrator_front_door ? esc_html__('Ask the Library.', 'sustainable-catalyst-library') : esc_html__('The Research Librarian is ready.', 'sustainable-catalyst-library'); ?></strong>
