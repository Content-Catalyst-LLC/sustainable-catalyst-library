            ...
            <div class="sc-field-spotlight__cards" data-supporting-cards>
                <?php foreach ( $initial['articles'] as $index => $article ) : ?>
                    <article class="sc-field-spotlight__card">
                        ...
                        <div class="sc-field-spotlight__card-copy"><p class="sc-field-spotlight__card-number">SELECTED ARTICLE <?php echo esc_html( str_pad( (string) ( $index + 1 ), 2, '0', STR_PAD_LEFT ) ); ?></p><h5><a href="<?php echo esc_url( (string) $article['url'] ); ?>"><?php echo esc_html( (string) $article['title'] ); ?></a></h5><?php if ( $article['metadata'] ) : ?><p class="sc-field-spotlight__card-meta"><?php echo esc_html( (string) $article['metadata'] ); ?></p><?php endif; ?><?php if ( $article['summary'] ) : ?><p class="sc-field-spotlight__card-summary"><?php echo esc_html( (string) $article['summary'] ); ?></p><?php endif; ?><?php if ( ! empty( $article['research_graph_url'] ) ) : ?><a class="sc-field-spotlight__research-graph" href="<?php echo esc_url( (string) $article['research_graph_url'] ); ?>"><?php esc_html_e( 'Research graph', 'sustainable-catalyst-library' ); ?> <span aria-hidden="true">→</span></a><?php endif; ?></div>
                    </article>
                <?php endforeach; ?>
            </div>
