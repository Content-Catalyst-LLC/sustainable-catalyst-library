...
$include_data = true;
?>
<div id="<?php echo esc_attr( $instance_id ); ?>" class="sc-field-spotlights sc-field-spotlights--single" data-sc-field-spotlights="v4.3.22.2" data-sc-field-spotlights-mode="single" data-sc-field-spotlights-runtime-state="server">
