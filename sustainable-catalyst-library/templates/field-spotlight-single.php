...
$include_data = true;
?>
<div id="<?php echo esc_attr( $instance_id ); ?>" class="sc-field-spotlights sc-field-spotlights--single" data-sc-field-spotlights="v4.3.22.1" data-sc-field-spotlights-mode="single">
