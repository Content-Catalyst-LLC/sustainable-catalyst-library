...
final class SC_Library_Extension_Bootstrap_V402 {
    ...
    private const MODULES = [
        ...
        'class-sc-library-saved-searches-watchlists-queue.php' => 'SC_Library_Saved_Searches_Watchlists_Queue',
        'class-sc-library-unified-research-projects-source-bundles.php' => 'SC_Library_Unified_Research_Projects_Source_Bundles',
        'class-sc-library-reading-notebook-annotations.php' => 'SC_Library_Reading_Notebook_Annotations',
        'class-sc-library-evidence-matrix-claim-intelligence.php' => 'SC_Library_Evidence_Matrix_Claim_Intelligence',
        'class-sc-library-knowledge-graph-evidence-intelligence.php' => 'SC_Library_Knowledge_Graph_Evidence_Intelligence',
        'class-sc-library-collaborative-research-rooms.php' => 'SC_Library_Collaborative_Research_Rooms',
        'class-sc-library-institutional-team-libraries.php' => 'SC_Library_Institutional_Team_Libraries',
        ...
        'class-sc-library-research-identity-authority-network.php' => 'SC_Library_Research_Identity_Authority_Network',
        'class-sc-library-public-evidence-claim-navigation.php' => 'SC_Library_Public_Evidence_Claim_Navigation',
        'class-sc-library-research-collections-curated-spaces.php' => 'SC_Library_Research_Collections_Curated_Spaces',
        ...
        'class-sc-library-research-portability-preservation.php' => 'SC_Library_Research_Portability_Preservation',
        'class-sc-library-unified-personal-research-environment.php' => 'SC_Library_Unified_Personal_Research_Environment',
