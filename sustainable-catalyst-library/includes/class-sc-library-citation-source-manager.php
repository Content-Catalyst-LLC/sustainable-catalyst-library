    ...
    public static function render_public_source_page( $source_id ) {
        ...
        <main class="sc-source-page" id="main-content">
            <article class="sc-source-record">
                ...
                <?php if ( class_exists( 'SC_Library_Source_Versioning_Integrity' ) ) : ?>
                    <?php echo SC_Library_Source_Versioning_Integrity::render_public_integrity_notice( $source_id ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                <?php endif; ?>
