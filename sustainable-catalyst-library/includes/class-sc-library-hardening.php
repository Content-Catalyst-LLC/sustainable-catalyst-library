...
final class SC_Library_Hardening {
    ...
    public const BRANCH_VERSION = '4.7.0';
    public const BRANCH_SCHEMA = 'sc-library-v47-production-certification/1.0';
    ...
    public function run_report(bool $persist = true, ?int $user_id = null): array {
        ...
        $categories['branch_43']['checks'][] = $this->check('v43-release-version', __('4.7 release version alignment', 'sustainable-catalyst-library'), $branch_version_ready, __('Plugin runtime is aligned to the certified 4.7.0 release.', 'sustainable-catalyst-library'), defined('SC_LIBRARY_VERSION') ? (string) SC_LIBRARY_VERSION : __('Not defined', 'sustainable-catalyst-library'), __('Reinstall the complete v4.7.0 package; do not mix files from different releases.', 'sustainable-catalyst-library'));
