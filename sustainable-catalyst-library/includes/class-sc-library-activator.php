...
final class SC_Library_Activator {
    ...
    public static function repair_publication_surface_integrity_runtime(): void {
        ...
        $diag['runtime_version'] = defined( 'SC_LIBRARY_VERSION' ) ? SC_LIBRARY_VERSION : '4.3.22.3';
    ...
    private static function repair_publication_surface_integrity(): void {
        ...
        $current_result['runtime_version'] = defined( 'SC_LIBRARY_VERSION' ) ? SC_LIBRARY_VERSION : '4.3.22.3';
