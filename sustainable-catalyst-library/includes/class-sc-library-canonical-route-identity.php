...
final class SC_Library_Canonical_Route_Identity {
    ...
    private const PRIVATE_ACCOUNT_CONTRACTS = array(
        ...
        'federation_manifests'   => 'sc_federation_share:post_author',
    );
    ...
    public function redirect_legacy_public_route() {
        ...
        nocache_headers();
        wp_safe_redirect( $target, 301, 'Sustainable Catalyst Library v5.3.0' );
        exit;
    }
    ...
    public function shortcode_account_continuity( $atts ) {
        ...
        ob_start();
        ?>
        <aside class="sc-library-account-continuity" data-sc-library-account-continuity="v5.3.0">
