...
final class SC_Library_Canonical_Route_Identity {
    ...
    public function redirect_legacy_public_route() {
        ...
        nocache_headers();
        wp_safe_redirect( $target, 301, 'Sustainable Catalyst Library v4.3.28' );
        exit;
    }
    ...
    public function shortcode_account_continuity( $atts ) {
        ...
        ob_start();
        ?>
        <aside class="sc-library-account-continuity" data-sc-library-account-continuity="v4.3.28">
