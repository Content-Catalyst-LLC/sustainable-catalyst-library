    ...
    public function render_meta_box(WP_Post $post): void {
        ...
        <div class="sc-library-admin-record sc-library-admin-documentation">
            ...
            <div class="sc-library-admin-grid">
                ...
                <label><span><?php esc_html_e('Version', 'sustainable-catalyst-library'); ?></span><input type="text" name="sc_library_doc_version" value="<?php echo esc_attr($meta['version']); ?>" placeholder="1.8.0 or July 2026"></label>
