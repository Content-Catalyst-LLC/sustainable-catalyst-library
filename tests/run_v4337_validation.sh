...
"$PY" -m pytest -q tests/test_publications_research_graph_v4337.py
...
"$PY" -m pytest -q \
 tests/test_open_learning_ii_v4336.py tests/test_access_intelligence_ii_v4335.py tests/test_metadata_quality_entity_resolution_v4334.py \
...
printf 'PASS - v4.3.37 Publications ↔ Research Graph Integration and retained compatibility.\n'
