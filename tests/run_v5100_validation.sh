...
PYTHONPATH="$ROOT/library-backend" "$PY" -m pytest -q \
  library-backend/tests/test_institutional_research_network_v200.py \
  tests/test_institutional_research_network_v5100.py
...
php -l sustainable-catalyst-library/includes/class-sc-library-institutional-research-network.php >/dev/null
php -l sustainable-catalyst-library/includes/class-sc-library-research-network-console.php >/dev/null
node --check sustainable-catalyst-library/assets/js/sc-library-institutional-network-v5100.js
printf '%s\n' 'PASS: Sustainable Catalyst Library v5.10.0 Institutional Research Network II validation'
