...
PYTHONPATH="$ROOT/library-backend" python3 -m pytest -q library-backend/tests/test_biomedical_sources_v130.py tests/test_biomedical_evidence_v580.py
...
printf 'PASS: Sustainable Catalyst Library v5.8.0 biomedical evidence validation\n'
