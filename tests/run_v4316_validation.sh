...
cd "$ROOT"
python3 -m pytest -q tests/test_pathway_aware_research_guidance_v4316.py
...
python3 -m pytest -q tests/test_research_librarian_front_door_v4314.py -k 'not release_identity_and_readme_contract'
...
echo 'PASS: v4.3.16 Pathway-Aware Research Guidance and retained compatibility.'
