...
python3 -m pytest -q tests/test_research_librarian_front_door_v4314.py
# Preserve v4.3.13 behavior while allowing the global release version to advance.
...
echo 'PASS: v4.3.14 Research Librarian front door, guided discovery, research flow, and v4.3.13 compatibility.'
