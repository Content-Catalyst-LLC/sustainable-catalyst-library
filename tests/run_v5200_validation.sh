...
echo "=== Knowledge Library v5.20.0 / backend v2.31.0 validation ==="
...
grep -q 'Version: 5.20.0' "$ROOT/sustainable-catalyst-library/sustainable-catalyst-library.php"
grep -q '__version__ = "2.31.0"' "$ROOT/library-backend/app/__init__.py"
...
grep -q 'data-sc-kl-query-text' "$ROOT/sustainable-catalyst-library/includes/class-sc-library-knowledge-landscape.php"
grep -q 'terrainPick' "$ROOT/sustainable-catalyst-library/assets/js/sc-library-knowledge-landscape-v5200.js"
grep -q 'matrix_cell_selection' "$ROOT/library-backend/app/publication_corpus_maps.py"
echo "PASS: Knowledge Library v5.20.0 Linked Scientific Views & Visual Query validation complete"
