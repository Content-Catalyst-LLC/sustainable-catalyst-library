...
cd "$ROOT"
PY="${PYTHON:-python3}"
PYTHONPATH="$ROOT/library-backend" "$PY" -m pytest -q library-backend/tests/test_medical_terminology_v150.py tests/test_medical_terminology_v582.py
"$PY" -m pytest -q tests/test_release_console_runtime_sync_v5811.py tests/test_fda_regulatory_intelligence_v581.py tests/test_biomedical_evidence_v580.py tests/test_johns_hopkins_widget_registry_v571.py tests/test_institutional_research_sources_v570.py \
...
printf '%s\n' 'PASS: Sustainable Catalyst Library v5.8.2 medical terminology and disease classification validation'
