...
set -euo pipefail
cd "$(dirname "$0")/.."
printf 'Sustainable Catalyst Library v4.1.3 validation\n\n'
grep -q 'Version: 4.1.3' sustainable-catalyst-library/sustainable-catalyst-library.php
grep -q "SC_LIBRARY_VERSION', '4.1.3" sustainable-catalyst-library/sustainable-catalyst-library.php
grep -q 'Stable tag: 4.1.3' sustainable-catalyst-library/readme.txt
...
printf '\nPASS: v4.1.3 Knowledge Library contrast and thumbnail validation completed.\n'
