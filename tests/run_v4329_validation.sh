...
"$PY" -m pytest -q tests/test_saved_searches_watchlists_research_queue_v4329.py
"$PY" -m pytest -q tests/test_personal_library_collections_recommendations_v4328.py -k 'not test_release_identity_and_module_registration and not test_account_continuity_health_remains_version_aligned_and_knows_my_library and not test_readme_and_release_docs_capture_current_contract'
...
printf 'PASS - v4.3.29 Saved Searches, Watchlists & Research Queue and retained compatibility.\n'
