...
cd "$ROOT"
PY="${SC_LIBRARY_VALIDATION_PYTHON:-python3}"
"$PY" -m pytest -q tests/test_pathway_editorial_course_refinement_v43202.py
...
printf 'PASS - v4.3.20.2 Knowledge Pathway Editorial Index & Course Catalog Refinement validation complete\n'
