...
PATCHER = ROOT / "apply_foundations_v2_0_0.py"
...
checks = {
    "version constant": "SC_LIBRARY_FOUNDATIONS_VERSION" in php and "'2.0.0'" in php,
...
print("PASS: Sustainable Catalyst Foundations v2.0.0 static suite")
