...
"$PY" -m pytest -q tests/test_personal_library_collections_recommendations_v4328.py
...
printf 'PASS - v4.3.28 Personal Library Collections & Recommendations and retained compatibility.\n'
