...
set -euo pipefail
cd "$(dirname "$0")/.."
printf 'Sustainable Catalyst Library v4.1.4 validation\n\n'
grep -q 'Version: 4.1.4' sustainable-catalyst-library/sustainable-catalyst-library.php
grep -q "SC_LIBRARY_VERSION', '4.1.4" sustainable-catalyst-library/sustainable-catalyst-library.php
grep -q 'Stable tag: 4.1.4' sustainable-catalyst-library/readme.txt
...
printf '\nPASS: v4.1.4 Knowledge Library progress indicator validation completed.\n'
