...
if command -v node >/dev/null 2>&1; then
 for f in \
  ...
  sustainable-catalyst-library/assets/js/sc-library-research-document-builder.js sustainable-catalyst-library/assets/js/sc-library-field-spotlights.js \
...
printf 'PASS - v4.3.36 Open Learning II and retained compatibility (173 selected regression tests).\n'
