...
if command -v node >/dev/null 2>&1; then
 for f in \
  ...
  sustainable-catalyst-library/assets/js/sc-library-personal-library-v4328.js \
  sustainable-catalyst-library/assets/js/sc-library-public-library-network.js \
  sustainable-catalyst-library/assets/js/sc-library-orchestrator.js sustainable-catalyst-library/assets/js/sc-library-connectors.js \
  sustainable-catalyst-library/assets/js/sc-library-research-document-builder.js \
  sustainable-catalyst-library/assets/js/sc-library-open-course-finder.js sustainable-catalyst-library/assets/js/sc-library-course-plan.js; do node --check "$f"; done
fi
printf 'PASS - v4.3.38 Research Librarian II — Project-Aware Guidance and retained compatibility.\n'
