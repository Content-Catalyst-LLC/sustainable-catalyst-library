...
def test_release_identity_and_go_runtime():
    assert "Version: 5.36.0" in read("sustainable-catalyst-library/sustainable-catalyst-library.php")
    assert '__version__ = "2.47.0"' in read("library-backend/app/__init__.py")
