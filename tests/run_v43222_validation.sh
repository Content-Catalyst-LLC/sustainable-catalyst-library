...
"$PY" -m pytest -q tests/test_publications_fail_open_v43222.py
...
printf 'PASS - v4.3.22.2 Publications Fail-Open Field Switching & Runtime Hardening validation complete\n'
