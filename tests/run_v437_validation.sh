...
cd "$ROOT"
python3 -m pytest -q tests/test_field_spotlights_v437.py
...
echo 'PASS: v4.3.7 Spotlight-parity hero scale, autoplay, progress/status, and fixed eight-panel disclosure.'
