...
cd "$ROOT"
python3 -m pytest -q tests/test_field_spotlights_v436.py
python3 -m pytest -q tests/test_field_spotlights_v435.py -k 'not release_markers_and_public_shortcodes'
...
echo 'PASS: v4.3.6 Field Spotlight Administration Console, readiness tracking, source search, and inherited public contracts.'
