...
"$PY" -m pytest -q tests/test_library_workspace_bidirectional_continuity_v4333.py
...
printf 'PASS - v4.3.33 Library ↔ Workspace Bidirectional Continuity and retained compatibility.\n'
