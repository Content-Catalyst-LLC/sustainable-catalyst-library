...
echo "=== Knowledge Library v5.20.0.1 / backend v2.31.1 validation ==="
...
node --check "$ROOT/sustainable-catalyst-library/assets/js/sc-library-knowledge-landscape-v5200.js"
...
grep -q 'Version: 5.20.0.1' "$ROOT/sustainable-catalyst-library/sustainable-catalyst-library.php"
grep -q '__version__ = "2.31.1"' "$ROOT/library-backend/app/__init__.py"
grep -q '@app.post("/v1/publication-knowledge-maps/corpus")' "$ROOT/library-backend/app/main.py"
grep -q 'publication_async_corpus_transport' "$ROOT/library-backend/app/main.py"
grep -q 'wp_remote_post' "$ROOT/sustainable-catalyst-library/includes/class-sc-library-python-backend.php"
grep -q 'data-sc-kl-load-state' "$ROOT/sustainable-catalyst-library/includes/class-sc-library-knowledge-landscape.php"
grep -q 'fetchCorpus' "$ROOT/sustainable-catalyst-library/assets/js/sc-library-knowledge-landscape-v5200.js"
grep -q 'Publication corpus unavailable' "$ROOT/sustainable-catalyst-library/assets/js/sc-library-knowledge-landscape-v5200.js"
...
echo "PASS: Knowledge Library v5.20.0.1 Asynchronous Publication Corpus Loading & Transport Repair validation complete"
