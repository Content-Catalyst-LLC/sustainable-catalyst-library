...
RELATIONSHIP_CLASSES: dict[str, str] = {
    ...
    "contains-scientific-object": "explicit-source-lineage",
    "contains-source-span": "explicit-source-lineage",
    "explicit-scientific-cross-reference": "explicit-source-lineage",
