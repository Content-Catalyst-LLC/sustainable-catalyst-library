# Sustainable Catalyst Knowledge Library 5.36.0
...
v5.36.0 introduces a dedicated Go job coordinator for research ingestion and document-processing workloads. It adds durable queued jobs, idempotent submission, priority, claim/ownership, retries, cancellation, completion, backpressure and worker-health contracts.
